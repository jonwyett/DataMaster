...
var DataMaster = function(data, fields, options) {
    ...
    */
    ...
    /**
     * Simple caller for the embedded TableGenerator library
     * @param {Object} template - The template to use
     * @param {Object} library - The library to use
     * @returns {Object} The generated table
     */
    this.createTable = function(template, library) {
        if (typeof template === 'undefined') { return null; }

        //If the user didn't provide an includeHeaders value, set it to true
        if (typeof template.settings.includeHeaders === 'undefined') { template.settings.includeHeaders = true; }
...
/*****************************************************************/
/***************   EMBEDDED TABLE GENERATOR CLASS   **************/
/*****************************************************************/
